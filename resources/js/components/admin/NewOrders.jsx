...
const NewOrders = () => {
    ...
    useEffect(() => {
        const fetchOrders = async () => {
            try {
                const response = await axios.get("/admin/api/orders/new");
...
const rootElement = document.getElementById("new-orders");
if (rootElement) {
    ReactDOM.createRoot(rootElement).render(<NewOrders />);
}
