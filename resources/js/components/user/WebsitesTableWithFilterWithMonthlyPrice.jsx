...
const WebsitesTableWithFilter = ({ initialCategories }) => {
    ...
    const [formValues, setFormValues] = useState({
        ...
        monthly_price: { min: 0, max: 10000 }, // Add this line
    });
    ...
    const handleSearch = (e) => {
        ...
        const newFormValues = {
            ...
            monthly_price: {
                // Add this block
                min: form.monthlyPriceMin.value,
                max: form.monthlyPriceMax.value,
            },
        };
        ...
        const newFilters = {
            ...
            monthly_price: {
                // Add this block
                min: parseInt(newFormValues.monthly_price.min) || 0,
                max: parseInt(newFormValues.monthly_price.max) || 10000,
            },
        };
                        ...
                        <div className="space-y-2 pl-4">
                            ...
                            <div className="flex gap-2">
                                <Input
                                    ...
                                    defaultValue={formValues.monthly_price.min}
                                    className="w-20"
                                    placeholder="Min"
                                />
                                <Input
                                    ...
                                    defaultValue={formValues.monthly_price.max}
                                    className="w-20"
                                    placeholder="Max"
                                />
                            </div>
