    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div class="bg-white rounded-xl shadow-lg p-6 sm:p-8">
                ...
                <form id="websiteForm" action="{{ route('publisher-add-website-post') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="domain_rating" id="domain_rating"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                                value="{{ old('domain_rating', '') }}" min="0" max="100" required>
                        </div>
                        <!-- Domain Authority -->
                        <div>
                            ...
                            <input type="number" name="domain_authority" id="domain_authority"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                                value="{{ old('domain_authority', '') }}" min="0" max="100" required>
                        </div>

                        <!-- Spam Score -->
                        <div>
                            <label for="spam_score" class="block text-sm font-medium text-gray-700">Spam Score
                                (mandatory)</label>
